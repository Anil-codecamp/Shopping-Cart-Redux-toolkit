                ...
                <div className="grid md:grid-cols-3 gap-7 mt-8">
                    ...
                    <div className="bg-gray-100 rounded-md p-4 lg:sticky top-0 mr-4 drop-shadow-lg">
                        ...
                        <div className="mt-8 space-y-2">
                            ...
                            <button type="button" className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent text-gray-800 border border-gray-300 rounded-md"><NavLink to="/">Continue Shopping</NavLink></button>
                        </div>
                    </div>
                </div>
            </div>
